...
//Consulta
$sql="SELECT * FROM `tblfluxo`, `paramtipos`, `tblempresas` WHERE `paramtipos`.`idTipo` LIKE `tblfluxo`.`idTipo` AND `tblfluxo`.`idEmpresa` LIKE `tblempresas`.`idEmpresa` ".$addSql." AND `tblfluxo`.`idTipoFluxo`=1  ORDER BY `tblfluxo`.`idfluxo` DESC";
...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
  <tr>
	<td style="width:20%;" class='midnight-blue'>Cliente</td>
