zz<div class="padding">
  <div class="row">
    <div class="col-lg-6">
      <!-- accordion -->
      <div ng-controller="AccordionCtl" class="m-b-lg">
          <script type="text/ng-template" id="group-template.php">
          ...
          <uib-accordion close-others="oneAtATime">
            ...
            <uib-accordion-group heading="Custom template" template-url="group-template.php">
              Hello
            </uib-accordion-group>
      ...
      <div ng-controller="AlertCtl" class="m-b-lg">
        <script type="text/ng-template" id="alert.php">
        ...
        <uib-alert template-url="alert.php">A happy alert!</uib-alert>
      ...
      <div ng-controller="DropdownCtl" class="box">
        ...
        <div class="box-body btn-groups">
          ...
          <div class="btn-group" uib-dropdown>
            ...
            <ul class="uib-dropdown-menu" template-url="dropdown.php" aria-labelledby="button-template-url">
            </ul>
          </div>
          ...
          <script type="text/ng-template" id="dropdown.php">
      ...
      <div ng-controller="ModalCtl" class="box">
          <script type="text/ng-template" id="myModalContent.php">
      ...
      <div ng-controller="TooltipCtl" class="box">
        ...
        <div class="box-body">
          ...
          <p>
            ...
            <a href="#" class="text-info" uib-tooltip-template="'myTooltipTemplate.php'">Custom template</a>
          </p>
          <p>
          ...
          <script type="text/ng-template" id="myTooltipTemplate.php">
