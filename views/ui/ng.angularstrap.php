    ...
    <div class="col-sm-6">
      ...
      <div ng-controller="AlertCtrl" class="m-b">
        ...
        <div class="btn-groups" append-source>
          ...
          <button type="button" class="btn btn-sm white" data-template-url="../views/blocks/tpl.alert.php" data-placement="top" data-duration="3" data-animation="am-fade-and-slide-top" data-container="#content" data-keyboard="true" bs-alert="alert">Custom alert
            <br />
      ...
      <div ng-controller="DropdownCtrl" class="m-b">
        ...
        <div class="m-b-xs">
          ...
          <button type="button" class="btn btn-sm white" data-animation="am-flip-x" data-template-url="../views/blocks/tpl.dropdown.php" data-placement="top-left" bs-dropdown="dropdown">Custom dropdown
            <br />
            <small>(using data-template)</small>
          </button>
        </div>
        <div>
          <button type="button" class="btn btn-sm white" data-animation="am-flip-x" data-template-url="../views/blocks/tpl.dropdown.php" data-placement="right" bs-dropdown="dropdown">Right position
            <br />
            <small>(using data-template)</small>
          </button>

          <button type="button" class="btn btn-sm white" data-animation="am-flip-x" data-template-url="../views/blocks/tpl.dropdown.php" data-placement="left" bs-dropdown="dropdown">Left position
            <br />
            <small>(using data-template)</small>
          </button>
        </div>
      ...
      <div ng-controller="PopoverCtrl" class="m-b">
        ...
        <div class="m-b">
          ...
          title="{{popover.title}}" 
          data-content="{{popover.content}}" 
          data-template-url="../views/blocks/tpl.popover.php" 
          data-animation="am-flip-x" 
    ...
    <div class="col-sm-6">
      ...
      <div ng-controller="ModalCtrl" class="m-b">
        ...
        <div class="btn-groups">
          ...
          data-template-url="../views/blocks/tpl.modal.php" 
          ...
          <button type="button" class="btn btn-sm white" 
          data-animation="am-fade-and-slide-top" 
          data-content-template="../views/blocks/tpl.modal.content.php"
          bs-modal="modal">Custom Modal
            <br />
      ...
      <div ng-controller="AsideCtrl" class="m-b">
        ...
        <div>
          ...
          <!-- You can use a custom html template with the `data-template` attr -->
          <button type="button" class="btn btn-sm white" data-template-url="../views/blocks/tpl.aside.php" data-placement="left" data-animation="am-slide-left aside-open-backdrop" bs-aside="aside" data-container="body">Custom aside
            <br />
            <small>(using data-template)</small>
          </button>
        </div>
