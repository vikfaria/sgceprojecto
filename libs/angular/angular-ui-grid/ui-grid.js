...
(function () {
  ...
  angular.module('ui.grid').constant('uiGridConstants', {
    ...
    // copied from http://www.lsauer.com/2011/08/javascript-keymap-keycodes-in-json.php
    keymap: {
      TAB: 9,
      STRG: 17,
      CAPSLOCK: 20,
...
.factory('GridOptions', ['gridUtil','uiGridConstants', function(gridUtil,uiGridConstants) {
  ...
  return {
    initialize: function( baseOptions ){
       ...
       * <pre>  $scope.gridOptions.headerTemplate = 'header_template.php';</pre>
       * inline html 
       ...
       * current 'ui-grid-header.php' template in github as your starting point.
       * 
       */
       ...
       * aggregation totals. 
       * When provided, this setting uses a custom footer template. Can be set to either the name of a template file 'footer_template.php', inline html
       ...
       * <pre> $scope.gridOptions.rowTemplate = 'row_template.php';</pre>
       * inline html 
      ...
      compile: function () {
        return {
          pre: function ($scope, $elm, $attrs) {
            ...
            var token = $attrs[alias1] || $attrs[alias2] || $elm.php();
            ...
            if ($attrs.$$observers) {
              ...
              observer = $attrs.$observe(prop, function (result) {
                if (result) {
                  $elm.php($parse(result)(i18nService.getCurrentLang()) || missing);
                }
              });
            }
            ...
            var listener = $scope.$on(i18nConstants.UPDATE_EVENT, function (evt) {
              if (observer) {
                ...
                $elm.php(getter(i18nService.get()) || missing);
              }
            });
...
(function () {
   ...
   *  with the columnDef.editableCellTemplate element ('cellEditor.php' by default).
   *
  ...
  module.service('uiGridExpandableService', ['gridUtil', '$compile', function (gridUtil, $compile) {
    var service = {
      initializeGrid: function (grid) {
         ...
         *  <pre>
         *    $scope.gridOptions = {
         *      expandableRowTemplate: 'expandableRowTemplate.php'
         *    }
         *  </pre>  
         */
