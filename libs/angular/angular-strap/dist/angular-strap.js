...
(function(window, document, undefined) {
  ...
  angular.module('mgcrea.ngStrap.typeahead', [ 'mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions' ]).provider('$typeahead', function() {
    var defaults = this.defaults = {
      ...
      templateUrl: 'typeahead/typeahead.tpl.php',
      trigger: 'focus',
      container: false,
      keyboard: true,
      html: false,
  ...
  angular.module('mgcrea.ngStrap.tooltip', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$tooltip', function() {
    var defaults = this.defaults = {
      ...
      target: false,
      placement: 'top',
      templateUrl: 'tooltip/tooltip.tpl.php',
      template: '',
  ...
  angular.module('mgcrea.ngStrap.timepicker', [ 'mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.helpers.dateFormatter', 'mgcrea.ngStrap.tooltip' ]).provider('$timepicker', function() {
    var defaults = this.defaults = {
      ...
      placement: 'bottom-left',
      templateUrl: 'timepicker/timepicker.tpl.php',
      trigger: 'focus',
      container: false,
      keyboard: true,
      html: false,
  ...
  angular.module('mgcrea.ngStrap.select', [ 'mgcrea.ngStrap.tooltip', 'mgcrea.ngStrap.helpers.parseOptions' ]).provider('$select', function() {
    var defaults = this.defaults = {
      ...
      prefixEvent: '$select',
      placement: 'bottom-left',
      templateUrl: 'select/select.tpl.php',
      trigger: 'focus',
      container: false,
      keyboard: true,
      html: false,
    ...
    return {
      ...
      link: function postLink(scope, element, attr, controller) {
        ...
        controller.$render = function() {
          ...
          element.php((selected ? selected : options.placeholder) + (options.caretHtml ? options.caretHtml : defaults.caretHtml));
        };
        if (options.multiple) {
  ...
  angular.module('mgcrea.ngStrap.popover', [ 'mgcrea.ngStrap.tooltip' ]).provider('$popover', function() {
    var defaults = this.defaults = {
      ...
      target: false,
      placement: 'right',
      templateUrl: 'popover/popover.tpl.php',
      contentTemplate: false,
      trigger: 'click',
      keyboard: true,
      html: false,
  ...
  angular.module('mgcrea.ngStrap.modal', [ 'mgcrea.ngStrap.core', 'mgcrea.ngStrap.helpers.dimensions' ]).provider('$modal', function() {
    var defaults = this.defaults = {
      ...
      prefixEvent: 'modal',
      placement: 'top',
      templateUrl: 'modal/modal.tpl.php',
      template: '',
      contentTemplate: false,
      container: false,
      element: null,
  ...
  angular.module('mgcrea.ngStrap.dropdown', [ 'mgcrea.ngStrap.tooltip' ]).provider('$dropdown', function() {
    var defaults = this.defaults = {
      ...
      placement: 'bottom-left',
      templateUrl: 'dropdown/dropdown.tpl.php',
      trigger: 'click',
      container: false,
      keyboard: true,
      html: false,
  ...
  angular.module('mgcrea.ngStrap.datepicker', [ 'mgcrea.ngStrap.helpers.dateParser', 'mgcrea.ngStrap.helpers.dateFormatter', 'mgcrea.ngStrap.tooltip' ]).provider('$datepicker', function() {
    var defaults = this.defaults = {
      ...
      placement: 'bottom-left',
      templateUrl: 'datepicker/datepicker.tpl.php',
      trigger: 'focus',
      container: false,
      keyboard: true,
      html: false,
  ...
  angular.module('mgcrea.ngStrap.aside', [ 'mgcrea.ngStrap.modal' ]).provider('$aside', function() {
    var defaults = this.defaults = {
      ...
      prefixEvent: 'aside',
      placement: 'right',
      templateUrl: 'aside/aside.tpl.php',
      contentTemplate: false,
      container: false,
      element: null,
      backdrop: true,
  ...
  angular.module('mgcrea.ngStrap.alert', [ 'mgcrea.ngStrap.modal' ]).provider('$alert', function() {
    var defaults = this.defaults = {
      ...
      prefixEvent: 'alert',
      placement: null,
      templateUrl: 'alert/alert.tpl.php',
      container: false,
      element: null,
      backdrop: false,
      keyboard: true,
