...
include '../connections/Connection.php';
  include_once("../classes/cadastro_educadoras.php");

  $cad = new cadastroeducadoras();
 
  
  if(isset($_POST['submit'])){
    $nomeEducadora = $_POST['nome'];
    $apelidoEducadora = $_POST['apelido'];
    $cellEducadora = $_POST['cell'];
    $emailEducadora = $_POST['email'];
    ...
    $cad -> setNomeEducadora($nomeEducadora);
    $cad -> setApelidoEducadora($apelidoEducadora);
    $cad -> setCellEducadora($cellEducadora);
    $cad -> setEmailEducadora($emailEducadora);
    $cad -> setMoradaEducadora($id_zona);
	$cad -> setFoto($foto);
	$cad -> IntroduzDadosEducadoras();
