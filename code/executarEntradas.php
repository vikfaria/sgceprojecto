...
?>
<form action="executarEntradas.php?id=<?=$saidaId?>" method="post" name="form1" id="form1">
  ...
  <div class="row box-body">
   ...
   <div class="form-group">
            ...
            <div class="col-md-12" style="padding: 0 2% 0 0;">
      		  <select name="nomeBanco" id="nomeBanco" class="form-control nomeBanco" ui-jp="select2" ui-options="{theme: 'bootstrap'}" style="width: 100%; " required>
