...
<form id="formEducadora" action ="../display/rg_actualizarEducadora.php" method="post">
...
?> 
	...
	<div class="row" align="center">
	 ...
	 <div class="modal-footer">
		...
		<button type="submit" name = "sub" id = "sub"   class="btn danger p-x-md">Confirmar</button>
</div>
 </div>
</form>